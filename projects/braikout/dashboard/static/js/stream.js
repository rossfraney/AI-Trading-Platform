...
channel.bind('trade', function (data) {
    ...
    document.getElementById("btcprice2").innerHTML = "BTC: " + data.price_str;
});
...
var channel5 = pusher.subscribe('live_trades_gbpusd');
channel5.bind('trade', function (data) {
    console.log(data)
    document.getElementById("gbpprice").innerHTML = "GBP: " + data.price_str;
});
channel5.bind('pusher:subscription_succeeded', function (data) {
    console.log("Subscribed correctly GBP")
});
